...
import styles from './MarturiiBotez.module.css'; // Fișierul de stiluri
  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        <p className={styles.subtitle}>Alege dintr-o gamă variată de mărturii personalizate pentru botezul micuțului tău.</p>

        <div className={styles.grid}>
          {/* Extragem datele pentru marturii de botez */}
